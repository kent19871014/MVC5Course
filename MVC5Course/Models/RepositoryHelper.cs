namespace MVC5Course.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw_ClientOrderTotalRepository Getvw_ClientOrderTotalRepository()
		{
			var repository = new vw_ClientOrderTotalRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw_ClientOrderTotalRepository Getvw_ClientOrderTotalRepository(IUnitOfWork unitOfWork)
		{
			var repository = new vw_ClientOrderTotalRepository();
			repository.UnitOfWork = unitOfWork;
			return repository;
